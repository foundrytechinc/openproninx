...
// PxSCTL: DET in 3:0, SPD in 7:4, IPM in 11:8
#define HBA_SCTL_DET_NONE 0x0
#define HBA_SCTL_DET_INIT 0x1
#define HBA_SCTL_IPM_DISABLED 0x300
...
struct hba_mem {
  ...
  volatile uint8_t vendor[0x100 - 0xA0]; // 0xA0 - 0xFF: Vendor specific
...
struct hba_cmd_tbl {
  ...
  struct hba_prdt_entry
      prdt[AHCI_PRDT_PER_CMD]; // 8 * 16 = 128 bytes (256B total, 128B aligned)
};
